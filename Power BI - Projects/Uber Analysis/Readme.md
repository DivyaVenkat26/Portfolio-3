...
Built data model linking Location, Trip Details, and Calendar tables.
...
Dynamic measures & titles: Update based on user filters.

Slicers & navigation: Date, City filters, and Clear button for easy use.
